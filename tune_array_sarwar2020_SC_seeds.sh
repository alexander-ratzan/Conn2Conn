#!/bin/bash
# Array: 10 seeds for Sarwar2020MLP (SC source) (0-9)
#SBATCH --nodes=1
...
#SBATCH --mem=96GB
#SBATCH --gres=gpu:1
#SBATCH --job-name=tune_sarwar_SC_array
#SBATCH --output=/scratch/asr655/neuroinformatics/Conn2Conn/results/logs/tune_sarwar_SC_array_%A_%a.out
#SBATCH --error=/scratch/asr655/neuroinformatics/Conn2Conn/results/logs/tune_sarwar_SC_array_%A_%a.err
...
echo "Model=Sarwar2020MLP  Source=SC  Seed=${SEED}"
