#!/bin/bash
# Array: 3 sources × 10 seeds = 30 tasks (0-29)
# task_id = seed_idx * 3 + source_idx
#SBATCH --nodes=1
...
#SBATCH --mem=64GB
#SBATCH --gres=gpu:1
#SBATCH --job-name=tune_learnable_array
#SBATCH --output=/scratch/asr655/neuroinformatics/Conn2Conn/results/logs/tune_learnable_array_%A_%a.out
#SBATCH --error=/scratch/asr655/neuroinformatics/Conn2Conn/results/logs/tune_learnable_array_%A_%a.err
...
CONFIGS=("CrossModal_PCA_PLS_learnable.yml" "CrossModal_PCA_PLS_learnable_SC_r2t.yml" "CrossModal_PCA_PLS_learnable_SC+SC_r2t.yml")
NUM_SOURCES=3
