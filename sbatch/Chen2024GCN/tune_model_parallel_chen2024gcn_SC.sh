...
#SBATCH --mem=96GB
#SBATCH --gres=gpu:4
#SBATCH --job-name=tune_chen_SC
#SBATCH --output=/scratch/asr655/neuroinformatics/Conn2Conn/results/logs/tune_chen_SC_%j.out
#SBATCH --error=/scratch/asr655/neuroinformatics/Conn2Conn/results/logs/tune_chen_SC_%j.err
