#!/bin/bash
# Array: 10 seeds for default Chen2024GCN (SC source) (0-9)
#SBATCH --nodes=1
...
#SBATCH --mem=96GB
#SBATCH --gres=gpu:1
#SBATCH --job-name=tune_chen_SC_array
#SBATCH --output=/scratch/asr655/neuroinformatics/Conn2Conn/results/logs/tune_chen_SC_array_%A_%a.out
#SBATCH --error=/scratch/asr655/neuroinformatics/Conn2Conn/results/logs/tune_chen_SC_array_%A_%a.err
...
echo "Model=Chen2024GCN  Source=SC  Seed=${SEED}"
