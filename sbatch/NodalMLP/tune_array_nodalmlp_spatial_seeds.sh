...
#SBATCH --output=/scratch/asr655/neuroinformatics/Conn2Conn/results/logs/tune_nodalmlp_spatial_array_%A_%a.out
...
echo "Model=NodalMLP  Source=SC  Features=spatial-only  Config=${CONFIG}  Seed=${SEED}"
