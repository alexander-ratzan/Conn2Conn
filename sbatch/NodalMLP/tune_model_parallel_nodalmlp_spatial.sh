...
#SBATCH --output=/scratch/asr655/neuroinformatics/Conn2Conn/results/logs/tune_nodalmlp_spatial_%j.out
#SBATCH --error=/scratch/asr655/neuroinformatics/Conn2Conn/results/logs/tune_nodalmlp_spatial_%j.err
...
CONFIG="NodalMLP_spatial.yml"

echo "Starting job ${SLURM_JOB_ID} on $(hostname) at $(date)"
echo "Model=NodalMLP  Source=SC  Features=spatial-only  Config=${CONFIG}"
