#!/bin/bash
# Array: 10 seeds for CrossModalPCA with SC source (0-9)
#SBATCH --nodes=1
...
#SBATCH --mem=32GB
#SBATCH --gres=gpu:1
#SBATCH --job-name=tune_pca_SC_array
#SBATCH --output=/scratch/asr655/neuroinformatics/Conn2Conn/results/logs/tune_pca_SC_array_%A_%a.out
#SBATCH --error=/scratch/asr655/neuroinformatics/Conn2Conn/results/logs/tune_pca_SC_array_%A_%a.err
...
echo "Model=CrossModalPCA  Source=SC  Seed=${SEED}"
