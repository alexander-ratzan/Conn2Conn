#!/bin/bash
# Array: 2 sources × 5 seeds = 10 tasks (0-9)
...
#SBATCH --mem=64GB
#SBATCH --gres=gpu:1
#SBATCH --job-name=tune_pca_array
#SBATCH --output=/scratch/asr655/neuroinformatics/Conn2Conn/results/logs/tune_pca_array_%A_%a.out
#SBATCH --error=/scratch/asr655/neuroinformatics/Conn2Conn/results/logs/tune_pca_array_%A_%a.err
