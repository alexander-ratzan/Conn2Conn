...
#SBATCH --gres=gpu:2
#SBATCH --job-name=tune_model_array
#SBATCH --output=/scratch/asr655/neuroinformatics/Conn2Conn/results/logs/tune_model_array_%A_%a.out
#SBATCH --error=/scratch/asr655/neuroinformatics/Conn2Conn/results/logs/tune_model_array_%A_%a.err
...
CONFIGS=(
  "models/configs/CrossModal_PCA_PLS_CovProjector.yml"
  "models/configs/CrossModal_PCA_PLS_CovProjector.yml"
  "models/configs/CrossModal_PCA_PLS_CovProjector_SC+SC_r2t.yml"
)
...
echo "Source=${SOURCE} Config=${CONFIG}"
