...
#SBATCH --mem=64GB
#SBATCH --gres=gpu:1
#SBATCH --job-name=tune_pcapls_array
#SBATCH --output=/scratch/asr655/neuroinformatics/Conn2Conn/results/logs/tune_pcapls_array_%A_%a.out
#SBATCH --error=/scratch/asr655/neuroinformatics/Conn2Conn/results/logs/tune_pcapls_array_%A_%a.err
...
CONFIGS=("CrossModal_PCA_PLS.yml" "CrossModal_PCA_PLS_SC_r2t.yml" "CrossModal_PCA_PLS_SC+SC_r2t.yml")
NUM_SOURCES=3
